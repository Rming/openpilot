...
def dmonitoringd_thread(sm=None, pm=None):
  ...
  while True:
    ...
    if sm.updated['carState']:
      ...
      if driver_engaged:
        driver_status.update(Events(), True, sm['carState'].cruiseState.enabled, sm['carState'].standstill, is_dm_enabled)
    ...
    if sm.updated['driverState']:
      ...
      driver_status.update(events, driver_engaged, sm['carState'].cruiseState.enabled, sm['carState'].standstill, is_dm_enabled)
