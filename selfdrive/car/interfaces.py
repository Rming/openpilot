...
class CarInterfaceBase():
  ...
  def create_common_events(self, cs_out, extra_gears=[], gas_resume_speed=-1, pcm_enable=True):
    ...
    if cs_out.gasPressed and not self.allowGasPress:
    ...
    if (cs_out.gasPressed and (not self.CS.out.gasPressed) and cs_out.vEgo > gas_resume_speed and (not self.allowGasPress)) or \
