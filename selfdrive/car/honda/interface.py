...
from selfdrive.car.honda.values import CruiseButtons, CAR, HONDA_BOSCH, AUDIO_HUD, Ecu, ECU_FINGERPRINT, FINGERPRINTS
...
class CarInterface(CarInterfaceBase):
  ...
  def update(self, c, can_strings):
    ...
    # events
    events = self.create_common_events(ret, pcm_enable=False, extra_gears=extra_gears)
